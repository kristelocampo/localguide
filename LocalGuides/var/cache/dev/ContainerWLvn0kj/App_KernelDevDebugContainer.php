...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pd3u7VlDcb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mV4Fq7PrfF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fcRXaSYouB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5dIwtpFnqb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('00Q+vr8qd2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), 1 => $e, 2 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($f, [], $g), 3 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $g), 4 => $e, 5 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $k, $f, $g), 6 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $l, $f), 7 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($f, true), 8 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 9 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 10 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 12 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $l, $k, $m, $b, $g, $n, [], $a), 13 => new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $l, $k, $b, $g, $n, NULL, $h, $a), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $g), 16 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $g, $c, $o, NULL)), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 22 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 23 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $k, $l, NULL), 'page', 'pagination', $h, $b), $h, $k, ($this->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), 24 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 25 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $l, $m), 26 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $d, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
